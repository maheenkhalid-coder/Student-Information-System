...
public class StudentOperation {
	...
	public void addStudent(String fname, String lname, int Age, int rollno, String dept, String Address, int enrollYear,
		...
		list.add(new StudentInfo(fname, lname, Age, rollno, dept, Address, enrollYear, number, email, course1, course2,
				course3, course4, course5, remainingBalance));
		numOfStudent++;
	}
	...
	public void getResult() {
		...
		System.out.println("From " + totalmarks + " marks you get " + sum + " marks in total.\n");
	...
	public StudentInfo search(int rollNum) {
